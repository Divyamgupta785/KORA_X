...
function takeCommand(message){
   ...
   if(message.includes("hello") || message.includes("hey") || message.includes("hi")|| message.includes("good") ){
    ...
    speak(date);
   } else if(message.includes("Divyam Gupta") || message.includes("who are you")|| message.includes("hu r u")|| message.includes("What is your name")){
    speak("I am KORA, your virtual assistant Created By Divyam Gupta");
    } else{
